...
export default function App() {
  ...
  // Memoize the paragraphs of the book being exported to avoid redundant splitting
  const exportingBookParagraphs = useMemo(() => {
    if (!exportingBook?.content) return [];
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  >
                    <option value="-1">Entire Book / Full Text ({exportingBookParagraphs.length} paragraphs)</option>
                    {exportingBookParagraphs.map((para, idx) => (
...
${exportingBookParagraphs.join("\n\n")}`;
                    } else {
                      contentToExport = exportingBookParagraphs[exportParagraphIndex] || "";
                  ...
                  onClick={() => {
                    ...
                    if (exportParagraphIndex === -1) {
                      dataToExport = {
                        ...
                        paragraphs: exportingBookParagraphs,
                      ...
                      dataToExport = {
                        ...
                        paragraphContent: exportingBookParagraphs[exportParagraphIndex] || ""
                      };
                      fileSuffix = `paragraph-${exportParagraphIndex + 1}`;
                    }
